...
document.getElementById('calculator-form').addEventListener('submit', function (e) {
    ...
    const gardening = parseFloat(document.getElementById('gardening').value);
...
function calculateWaterFootprint(
    ...
    const showerFactor = 3.5; // Liters per minute
    const dishwasherFactor = 9.5; // Liters per load
    const laundryFactor = 20; // Liters per load
    const toiletFactor = 4.8; // Liters per flush
    const cookingFactor = 5; // Liters per time
    const gardeningFactor = 23; // Liters per time
    const drinkingFactor = 1; // Liters per liter
    const cleaningFactor = 1.5; // Liters per minute
    const carwashFactor = 8; // Liters per minute
    ...
    const cookingFootprint = cooking * cookingFactor;
    const gardeningFootprint = gardening * gardeningFactor;
